...
class HardwareBLESerial {
  ...
  private:
    ...
    BLECharacteristic receiveCharacteristic = BLECharacteristic("6E400002-B5A3-F393-E0A9-E50E24DCCA9E", BLEWrite | BLERead, 247); //BLE_ATTRIBUTE_MAX_VALUE_LENGTH
    BLECharacteristic transmitCharacteristic = BLECharacteristic("6E400003-B5A3-F393-E0A9-E50E24DCCA9E", BLENotify | BLERead, 247); //BLE_ATTRIBUTE_MAX_VALUE_LENGTH
